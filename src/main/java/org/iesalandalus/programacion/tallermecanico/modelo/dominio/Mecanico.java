...
public class Mecanico extends Trabajo{
    ...
    public String toString() {
        String resultado = String.format("Mecánico -> %s - %s (%s - %s): %s horas, %.2f € en material", getCliente().toString(), getVehiculo().toString(), getFechaInicio(), (estaCerrado()? getFechaFin() : ""), getHoras(), getPrecioMaterial()).replace(".",",");
        if (estaCerrado()){
